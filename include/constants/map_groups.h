...
#define MAP_STARTMAP                      (60 | (0 << 8))
#define MAP_POKEMON_LEAGUE_RECEPTION_GATE (61 | (0 << 8))
#define MAP_ROUTE22                       (62 | (0 << 8))
#define MAP_ROUTE2                        (63 | (0 << 8))
#define MAP_PEWTER_CITY                   (64 | (0 << 8))
#define MAP_ROUTE3                        (65 | (0 << 8))
#define MAP_ROUTE4                        (66 | (0 << 8))
#define MAP_CERULEAN_CITY                 (67 | (0 << 8))
...
#define MAP_REDS_HOUSE                           (5 | (1 << 8))
#define MAP_BLUES_HOUSE                          (6 | (1 << 8))
#define MAP_PALLET_DAYCARE                       (7 | (1 << 8))
#define MAP_OAKSLAB                              (8 | (1 << 8))
#define MAP_POKESUPERCENTER                      (9 | (1 << 8))
#define MAP_POKESUPERCENTER2                     (10 | (1 << 8))
#define MAP_PALLETTOWNHOUSE1                     (11 | (1 << 8))
