static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROUTE1 - 1] = {MAP_GROUP(ROUTE1), MAP_NUM(ROUTE1), 12, 22},
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 27, 24},
    [HEAL_LOCATION_POKEMON_LEAGUE_RECEPTION_GATE - 1] = {MAP_GROUP(POKEMON_LEAGUE_RECEPTION_GATE), MAP_NUM(POKEMON_LEAGUE_RECEPTION_GATE), 18, 10},
    [HEAL_LOCATION_ROUTE22 - 1] = {MAP_GROUP(ROUTE22), MAP_NUM(ROUTE22), 18, 7},
    [HEAL_LOCATION_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 12, 36},
};
